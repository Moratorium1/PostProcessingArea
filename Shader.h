...
extern ID3D11PixelShader*  gVerticalColourGradientPostProcess;
extern ID3D11PixelShader*  gBlurPostProcess;
extern ID3D11PixelShader*  gWaterPostProcess;

extern ID3D11PixelShader*  gVertGaussianPostProcess;
extern ID3D11PixelShader*  gHorizGaussianPostProcess;
